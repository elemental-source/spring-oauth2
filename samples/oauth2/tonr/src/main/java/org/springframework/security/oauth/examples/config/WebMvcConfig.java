...
import org.springframework.security.oauth.examples.tonr.impl.RestTemplateFactory;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public RestTemplateFactory restTemplateFactory() {
        ...
        restTemplateFactory.setOAuth2ClientContext(clientContext);
    ...
    @Bean
    public SparklrController sparklrController(@Qualifier("sparklrServicePassword")
...
//        sparklrService.setTrustedClientRestTemplate(trustedClientRestTemplate);
    ...
    @Bean
    public SparklrServiceImpl sparklrServicePassword(@Value("${sparklrPhotoListURL}")
                                                             String sparklrPhotoListURL, @Value("${sparklrPhotoURLPattern}")
                                                             String sparklrPhotoURLPattern, @Value("${sparklrTrustedMessageURL}")
                                                             String sparklrTrustedMessageURL, @Qualifier("trustedSparklrPasswordRestTemplate")
                                                             RestOperations trustedSparklrPasswordRestTemplate) {
        SparklrServiceImpl sparklrService = new SparklrServiceImpl();
        sparklrService.setSparklrPhotoListURL(sparklrPhotoListURL);
        sparklrService.setSparklrPhotoURLPattern(sparklrPhotoURLPattern);
        sparklrService.setSparklrTrustedMessageURL(sparklrTrustedMessageURL);
        sparklrService.setRestTemplateFactory(restTemplateFactory());
//        sparklrService.setSparklrRestTemplate(trustedSparklrPasswordRestTemplate);
        return sparklrService;
    }
    ...
    protected static class ResourceConfiguration {
        ...
        @Bean
        public OAuth2ProtectedResourceDetails sparklrPassword() {
            ResourceOwnerPasswordResourceDetails details = new ResourceOwnerPasswordResourceDetails();
            details.setId("sparklr/tonr-password");
...
//			details.setGrantType("password");
        ...
        @Bean
        public OAuth2RestTemplate trustedSparklrPasswordRestTemplate() {
            return new OAuth2RestTemplate(sparklrPassword(), clientContext);
        }
